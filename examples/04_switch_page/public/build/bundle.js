...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div_1, "padding", "10px");
    			set_style(div_1, "left", (1 - /*x*/ ctx[0]) * 25 + "%");
    			set_style(div_1, "opacity", /*x3*/ ctx[2]);
    			set_style(div_1, "cursor", "pointer");
    			add_location(div_1, file$1, 29, 6, 931);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div_1, "click", /*click_handler*/ ctx[8], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*$drvHead*/ ctx[5] > 0 && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text("Main page\r\n          ");
    			div2_1 = element("div");
    			div2_1.textContent = "details >";
    			t7 = space();
    			div8 = element("div");
    			div7 = element("div");
    			div6 = element("div");
    			div6.textContent = "Here are some details";
    			t9 = space();
    			create_component(playcontrols.$$.fragment);
    			set_style(div0, "position", "absolute");
    			set_style(div0, "padding", "10px");
    			set_style(div0, "opacity", 1 - /*x2*/ ctx[1]);
    			set_style(div0, "transform", "translate(" + /*x*/ ctx[0] * -80 + "%,0)");
    			add_location(div0, file$1, 23, 4, 758);
    			set_style(div1, "position", "absolute");
    			set_style(div1, "padding", "10px");
    			set_style(div1, "opacity", /*x3*/ ctx[2]);
    			set_style(div1, "transform", "translate(" + (1 - /*x*/ ctx[0]) * 80 + "%,0)");
    			add_location(div1, file$1, 35, 4, 1129);
    			set_style(header, "background-color", "gray");
    			set_style(header, "height", "50px");
    			set_style(header, "color", "white");
    			set_style(header, "display", "flex");
    			set_style(header, "align-items", "center");
    			set_style(header, "justify-content", "center");
    			set_style(header, "position", "relative");
    			add_location(header, file$1, 21, 2, 611);
    			set_style(div2_1, "position", "absolute");
    			set_style(div2_1, "right", "0");
    			set_style(div2_1, "top", "0");
    			set_style(div2_1, "padding", "10px");
    			set_style(div2_1, "cursor", "pointer");
    			add_location(div2_1, file$1, 48, 10, 1555);
    			add_location(div3, file$1, 46, 8, 1517);
    			set_style(div4, "padding", "10px");
    			add_location(div4, file$1, 45, 6, 1480);
    			set_style(div5, "background-color", "hsl(0,0%,90%)");
    			set_style(div5, "width", "100%");
    			set_style(div5, "height", "100%");
    			set_style(div5, "position", "absolute");
    			add_location(div5, file$1, 42, 4, 1356);
    			add_location(div6, file$1, 61, 8, 1959);
    			set_style(div7, "padding", "10px");
    			add_location(div7, file$1, 60, 6, 1922);
    			set_style(div8, "background-color", "lightyellow");
    			set_style(div8, "width", "100%");
    			set_style(div8, "height", "100%");
    			set_style(div8, "position", "relative");
    			set_style(div8, "left", "100%");
    			add_location(div8, file$1, 57, 4, 1789);
    			set_style(div9, "position", "relative");
    			set_style(div9, "overflow", "hidden");
    			set_style(div9, "height", "300px");
    			add_location(div9, file$1, 41, 2, 1289);
    			set_style(div10, "width", "200px");
    			set_style(div10, "border", "1px solid");
    			add_location(div10, file$1, 20, 0, 564);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div2_1, "click", /*click_handler_1*/ ctx[9], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let drvInstance = new drv.addAnimation(0,
    	1000,
    	t => {
    			$$invalidate(0, x = t);
    			$$invalidate(1, x2 = drvInstance.slice(0, 0.45).valueOf());
    			$$invalidate(2, x3 = drvInstance.slice(0.55, 1).valueOf());
    		});

    	let drvHead = drv.playheadStore;
    	validate_store(drvHead, "drvHead");
    	component_subscribe($$self, drvHead, value => $$invalidate(5, $drvHead = value));
    	let div;
    	let div2;
    	...
    	const click_handler = () => drv.rewind();
    	const click_handler_1 = () => drv.play();

    	function div5_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			div = $$value;
    			($$invalidate(3, div), $$invalidate(0, x));
    		});
    	}
    	...
    	function div8_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			div2 = $$value;
    			($$invalidate(4, div2), $$invalidate(0, x));
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("drvHead" in $$props) $$invalidate(7, drvHead = $$props.drvHead);
    		if ("div" in $$props) $$invalidate(3, div = $$props.div);
    		if ("div2" in $$props) $$invalidate(4, div2 = $$props.div2);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*div, x*/ 9) {
    			 if (div) $$invalidate(3, div.style.transform = "translate(" + x * -20 + "%, 0)", div);
    		}

    		if ($$self.$$.dirty & /*div2, x*/ 17) {
    			 if (div2) $$invalidate(4, div2.style.transform = "translate(" + x * -100 + "%, 0)", div2);
    		}
    	};
