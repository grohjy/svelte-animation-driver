...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div2_1 = element("div");
    			div0 = element("div");
    			div0.textContent = "click or drag me";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "easing";
    			t3 = space();
    			create_component(playcontrols.$$.fragment);
    			set_style(div0, "background-color", "pink");
    			set_style(div0, "width", "150px");
    			set_style(div0, "height", "50px");
    			set_style(div0, "text-align", "center");
    			add_location(div0, file$1, 68, 2, 1908);
    			set_style(div1, "background-color", "lightgray");
    			set_style(div1, "width", "150px");
    			set_style(div1, "height", "50px");
    			set_style(div1, "text-align", "center");
    			add_location(div1, file$1, 78, 2, 2165);
    			set_style(div2_1, "width", "400px");
    			set_style(div2_1, "border", "1px solid");
    			add_location(div2_1, file$1, 67, 0, 1861);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2_1, anchor);
    			append_dev(div2_1, div0);
    			/*div0_binding*/ ctx[9](div0);
    			append_dev(div2_1, t1);
    			append_dev(div2_1, div1);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "click", /*move*/ ctx[5], false, false, false),
    					listen_dev(div0, "mousedown", /*mdown*/ ctx[6], false, false, false),
    					listen_dev(div0, "mousemove", /*mmove*/ ctx[7], false, false, false),
    					listen_dev(div0, "mouseup", /*mup*/ ctx[8], false, false, false),
    					listen_dev(div0, "mouseout", /*mup*/ ctx[8], false, false, false),
    					listen_dev(div1, "click", /*move*/ ctx[5], false, false, false),
    					listen_dev(div1, "mousedown", /*mdown*/ ctx[6], false, false, false),
    					listen_dev(div1, "mousemove", /*mmove*/ ctx[7], false, false, false),
    					listen_dev(div1, "mouseup", /*mup*/ ctx[8], false, false, false),
    					listen_dev(div1, "mouseout", /*mup*/ ctx[8], false, false, false)
    				];
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div2_1);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let x;
    	let drvInstance = new drv.addAnimation(0, 2000, t => $$invalidate(11, x = t));
    	let drvProps = drv.propsStore;
    	validate_store(drvProps, "drvProps");
    	component_subscribe($$self, drvProps, value => $$invalidate(18, $drvProps = value));
    	let drvHead = drv.playheadStore;
    	validate_store(drvHead, "drvHead");
    	component_subscribe($$self, drvHead, value => $$invalidate(17, $drvHead = value));
    	let div;
    	let div2;
    	let dist;
    	let isDrag = false;
    	...
    	onMount(() => {
    		$$invalidate(12, dist = div.parentElement.clientWidth - div.clientWidth);
    	});

    	const move = e => {
    		if (!isDrag) {
    			if ($drvHead == 0) drv.play(); else if ($drvHead == 1) drv.rewind(); else if ($drvProps.playing) drv.pause(); else drv.start();
    		}
    	};
    	...
    	const mmove = e => {
    		...
    		if (dragXStart !== 0 && Math.abs(dragX) > 1) {
    			...
    			isDrag = true;
    			drv.pause();
    			if (dragX / dist > 0) set_store_value(drvProps, $drvProps.direction = "fwd", $drvProps); else set_store_value(drvProps, $drvProps.direction = "rew", $drvProps);
    			set_store_value(drvHead, $drvHead = drvHeadStart + dragX / dist);
    		}
    	};
    	...
    	const mup = e => {
    		if (dragXStart !== 0 && isDrag) {
    			e.preventDefault();
    			let dir = "";
    			if ($drvHead > 0.9) dir = "fwd"; else if ($drvHead < 0.1) dir = "rew"; else if (dragX > 0) dir = "fwd"; else dir = "rew";
    			if (dir == "fwd") drv.play(); else drv.rewind();
    		}
    	...
    	function div0_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			div = $$value;
    			(($$invalidate(0, div), $$invalidate(11, x)), $$invalidate(12, dist));
    		});
    	}
    	...
    	function div1_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			div2 = $$value;
    			(($$invalidate(1, div2), $$invalidate(11, x)), $$invalidate(12, dist));
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("drvInstance" in $$props) drvInstance = $$props.drvInstance;
    		if ("drvProps" in $$props) $$invalidate(3, drvProps = $$props.drvProps);
    		if ("drvHead" in $$props) $$invalidate(4, drvHead = $$props.drvHead);
    		if ("div" in $$props) $$invalidate(0, div = $$props.div);
    		if ("div2" in $$props) $$invalidate(1, div2 = $$props.div2);
    		if ("dist" in $$props) $$invalidate(12, dist = $$props.dist);
    		if ("isDrag" in $$props) isDrag = $$props.isDrag;
    		if ("dragXStart" in $$props) dragXStart = $$props.dragXStart;
    		if ("dragX" in $$props) dragX = $$props.dragX;
    		if ("drvHeadStart" in $$props) drvHeadStart = $$props.drvHeadStart;
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*div, x, dist*/ 6145) {
    			 if (div) $$invalidate(0, div.style.transform = "translate(" + x * dist + "px, 0)", div);
    		}

    		if ($$self.$$.dirty & /*div2, x, dist*/ 6146) {
    			 if (div2) $$invalidate(1, div2.style.transform = "translate(" + cubicInOut(x) * dist + "px, 0)", div2);
    		}
    	};
