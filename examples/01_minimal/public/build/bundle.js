...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "background-color", "pink");
    			set_style(div, "width", /*x*/ ctx[0] * 100 + 250 + "px");
    			add_location(div, file$1, 9, 0, 243);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let x;
    	new drv.addAnimation(0, 3000, t => $$invalidate(0, x = t));
    	drv.play();
    	...
    	$$self.$capture_state = () => ({ PlayControls, animationDriver, drv, x });
