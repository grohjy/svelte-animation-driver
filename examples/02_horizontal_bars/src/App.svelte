...
<div style="position:relative; border:1px solid;overflow:hidden;width:450px;">
  <div
  ...
  <div
    style="background-color:yellow;width:{sineOut(x2) * 200 + 50}px;padding:5px;margin:5px
    0;">
    Delay
  </div>
  <div
    style="width:{elasticOut(x1, 0.8) * 200 + 50}px;
